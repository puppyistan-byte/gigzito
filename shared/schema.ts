...
// === ENUMS ===
export const subscriptionTierEnum = pgEnum("subscription_tier", ["GZLurker", "GZGroups", "GZMarketer", "GZMarketerPro", "GZBusiness", "GZEnterprise"]);
...
export const listingComments = pgTable("listing_comments", {
  id: serial("id").primaryKey(),
  listingId: integer("listing_id").notNull().references(() => videoListings.id, { onDelete: "cascade" }),
  authorUserId: integer("author_user_id").references(() => users.id, { onDelete: "set null" }),
  authorName: text("author_name").notNull().default("Anonymous"),
  commentText: text("comment_text").notNull(),
  isClean: boolean("is_clean").notNull().default(true),
...
export const businessProfiles = pgTable("business_profiles", {
  ...
  description: text("description"),
  pointsOfContact: json("points_of_contact").$type<{ title: string; name: string; phone?: string; email?: string }[]>(),
