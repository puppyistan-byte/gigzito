    ...
    >
      <div
        ...
        style={{
          ...
          boxShadow: "0 4px 24px rgba(255,43,43,0.2), 0 2px 8px rgba(0,0,0,0.6)",
          ...
          <div className="cursor-pointer">
            ...
            <div className="flex items-center gap-1.5 px-2 py-2">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p style={{ fontSize: "9px", color: "rgba(255,255,255,0.45)", whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}>{provider.displayName}</p>
              </div>
